package com.lauren.simplenews.menu1.presenter;

import com.lauren.simplenews.beans.NewsBean;
import com.lauren.simplenews.commons.Urls;
import com.lauren.simplenews.menu1.model.NewsModel;
import com.lauren.simplenews.menu1.model.NewsModelImpl;
import com.lauren.simplenews.menu1.view.NewsView;
...
public class NewsPresenterImpl implements NewsPresenter, NewsModelImpl.OnLoadNewsListListener {
    ...
    private String getUrl(int type, int pageIndex) {
        ...
        switch (type) {
            case Fragment1.NEWS_TYPE_TOP:
                sb.append(Urls.TOP_URL).append(Urls.TOP_ID);
                break;
            case Fragment1.NEWS_TYPE_NBA:
                sb.append(Urls.COMMON_URL).append(Urls.NBA_ID);
                break;
            case Fragment1.NEWS_TYPE_CARS:
                sb.append(Urls.COMMON_URL).append(Urls.CAR_ID);
                break;
            case Fragment1.NEWS_TYPE_JOKES:
